...
class UserService {
    ...
    verifyAccessToken(token) {
        return jwt.verify(token, jwtConfig.accessTokenSecret, { expiresIn: jwtConfig.accessTokenLife });
    }

    verifyRefreshToken(token) {
        return jwt.verify(token, jwtConfig.refreshTokenSecret, { expiresIn: jwtConfig.refreshTokenLife });
    }

    verifyEmailToken(token) {
        return jwt.verify(token, jwtConfig.verifyEmailTokenSecret, { expiresIn: jwtConfig.verifyEmailTokenLife });
    }
